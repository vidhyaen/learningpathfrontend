                 ...
                 <div class="row technology">
                    ...
                    <div class="col">
                        <div class="card">
                           ...
                           width="180" class="technology"/>
                           <h3>Frontend Developer</h3> 
                           {/* <i class="fa-regular fa-heart"></i> */}
                           </center>
                           <div class="technology">
                           <button class="btn btn-outline-warning btn-lg"
                           onClick={frontendHandler}>Know More</button>
                    ...
                    <div class="col">
                           <div class="card">
                            ...
                            width="180" height="180" alt="backend" class="technology"/>
                             <h3>Backend  Developer</h3> 
                             </center>
                             <div class="technology">
                             <button class="btn btn-outline-warning btn-lg ">Know More</button>
                             </div>
                    ...
                    <div class="col">
                       <div class="card">
                        <center>
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTEzQ7_0GChlVnDsf3mT2O4rSgDlpScRrj06Q&usqp=CAU" 
                            width="200" height="180" alt="cloud"  class="technology"/>
                            <h3>UI Design</h3> 
                             </center>
                             <div class="technology">
                             <button class="btn btn-outline-warning btn-lg">Know More</button> 
